...
public class favorite_cycle extends RecyclerView.Adapter<favorite_cycle.ViewHolder> {
    Context context;
    ArrayList<categoryitem> categories=new ArrayList<categoryitem>();


    public favorite_cycle(){}
    public favorite_cycle( ArrayList<categoryitem> categories){
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.favoritelist, viewGroup, false);
    ...
    @Override
    public void onBindViewHolder(@NonNull final favorite_cycle.ViewHolder viewHolder, int i) {
